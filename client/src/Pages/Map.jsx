...
const Map = () => {
    ...
    loader.load().then(() => {
        ...
        //SE AGREGA FUNCIONALIDAD DE CLICK PARA AGREGAR MARCADORES EN EL MAPA//
        ...
        //GUARDAR MARCADOR NUEVO EN UN NUEVO ITEM
        if (lat && lng) {
            axios.post('http://localhost:8000/api/pit', {
                name: "DefaultName",
                type: "Normal",
                dpt: "Agregada desde el mapa",
                lat,
                lng,
                ...
                .then(res => {
                    ...
                    navigate(`/pit/${res.data._id}/Edit`);
                })
                .catch(err => {
                    console.log(err)
                })
